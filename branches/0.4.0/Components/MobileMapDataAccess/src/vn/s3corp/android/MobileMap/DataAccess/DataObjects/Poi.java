...
public class Poi {
    ...
    public boolean addPicture(Picture picture) {
        return this.mPictures.add(picture);
    }
    ...
    /**
     * Remove all phone numbers of POI.
     * 
     * @param
     * @return
     * @author nam.tran
    ...
    public Poi() {
         ...
         * @author hieu.ha
         */
        this.mPictures = new ArrayList<Picture>();
    }
    ...
    public Poi(Poi poi) {
        if (null != poi) {
            ...
            this.mEmails = poi.getEmails();
            this.mPhoneNumbers = poi.getPhoneNumbers();
            /**
             * @author hieu.ha
             */
            this.mPictures = poi.getPictures();
        } else {
            this.mId = 0;
            this.mLongitude = 0;
            this.mLatitude = 0;
